...
import { countryEntityAction } from '../actions/stripeActions';

const StripeDetailsScreen = () => {
  ...
  const handleSubmit = () =>{
    dispatch(countryEntityAction({country, entity}))
    navigate(`/user/personal/details/${params.id}`)
  }
  return (
    <div className='fluid d-flexjustify-content-center'>
      <Row className='mx-auto p-5 rounded '>
        <Col md={6} className='d-flex flex-column rounded p-2 justify-content-center mx-auto bg-secondary'>
          ...
          <Form variant='light'>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <Form.Text className=''>Tell us about your business</Form.Text>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Group onChange={(e)=>setEntity(e.target.value)} value={entity}>
              <Form.Text className='text-light mb-3'>Type of entity</Form.Text>
              <Form.Check
...
export default StripeDetailsScreen;
